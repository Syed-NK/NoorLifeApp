...
export function WelcomeScreen() {
  ...
  // No step indicator and no swipe-back — see the note in login-screen. Welcome is reached by
  // `replace` from onboarding, so there is nothing behind it to swipe to.
  return (
